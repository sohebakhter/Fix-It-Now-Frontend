        ...
        <div className="relative z-10 space-y-8 my-auto">
          <div className="space-y-4">
            ...
            <p className="text-lg text-sky-100/90 leading-relaxed font-light">
              Sign in to manage your appointments, connect with service
              professionals, or trace your ongoing job statuses.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm p-3.5 rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300">
              <ShieldCheck className="h-6 w-6 text-sky-300 shrink-0" />
              <div>
            ...
            <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm p-3.5 rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300">
              <Clock className="h-6 w-6 text-sky-400 shrink-0" />
              <div>
                <h4 className="font-semibold text-sm">Efficient Dashboards</h4>
                <p className="text-xs text-sky-200/80">
                  Quick links to check tasks, message customers, or track
                  status.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm p-3.5 rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-xs text-sky-300/80">
                  Stay updated on active service requests and incoming offers.
                </p>
              </div>
            </div>
          </div>
